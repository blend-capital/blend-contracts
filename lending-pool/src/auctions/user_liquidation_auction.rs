...
mod tests {
    ...
    // TODO: test should be deleted since quoting in d and b tokens makes it unecessary
    // #[test]
    ...
    //     let (mut reserve_config_0, mut reserve_data_0) = testutils::default_reserve_meta(&e);
    //     reserve_data_0.last_time = 12345;
    //     reserve_data_0.b_rate = 1_300_000_000;
    //     reserve_config_0.c_factor = 0_8500000;
    //     reserve_config_0.l_factor = 0_9000000;
    //     reserve_config_0.index = 0;
    //     testutils::create_reserve(
    ...
    //     let (underlying_1, _) = testutils::create_token_contract(&e, &bombadil);
    //     let (mut reserve_config_1, mut reserve_data_1) = testutils::default_reserve_meta(&e);
    //     reserve_data_1.b_rate = 1_600_000_000;
    //     reserve_data_1.b_rate = 2_100_000_000;
    //     reserve_config_1.c_factor = 0_1000000;
    //     reserve_config_1.l_factor = 0_7000000;
    //     reserve_data_1.last_time = 12345;
    //     reserve_config_1.index = 1;
    //     testutils::create_reserve(
    ...
    //     let liquidation_data = LiquidationMetadata {
    //         collateral: map![&e, (underlying_0.clone(), 2)],
    //         liability: map![&e, (underlying_1.clone(), 1)],
    //     };
    //     let pool_config = PoolConfig {
    //         oracle: oracle_address,
    //         bstop_rate: 0_100_000_000,
    ...
    //     };
    //     let positions = Positions {
    //         collateral: map![&e, (reserve_config_0.index.clone(), 2)],
    //         liabilities: map![&e, (reserve_config_1.index.clone(), 1)],
    //         supply: map![&e,],
    //     };
    //     e.as_contract(&pool_address, || {
    //         storage::set_user_positions(&e, &samwise, &positions);
    ...
    //         //liquidate user
    //         let auction_data = AuctionData {
    //             bid: map![&e, (reserve_config_1.index, 0)],
    //             lot: map![&e, (reserve_config_0.index, 2)],
    //             block: 50,
    //         };
    //         let result = fill_user_liq_auction(&e, &auction_data, &samwise, &frodo);
    //         assert_eq!(result.bid.len(), 1);
    ...
    //         assert_eq!(
    //             result.bid.get_unchecked(0).unwrap_optimized(),
    //             (underlying_1.clone(), 0)
    //         );
    //         assert_eq!(
    //             result.lot.get_unchecked(0).unwrap_optimized(),
    //             (underlying_1, 00_0000002)
    //         );
    //         let frodo_positions = storage::get_user_positions(&e, &frodo);
    //         assert_eq!(
    //             frodo_positions
