...
impl PositionData {
    ...
    pub fn as_health_factor(&self) -> i128 {
        self.collateral_base.fixed_div_ceil(self.liability_base, 10i128.pow(self.decimals)).unwrap()
    }
    ...
    pub fn require_healthy(&self, e: &Env) {
        ...
        let min_health_factor = 10i128.pow(self.decimals).fixed_mul_floor(1_0000100, SCALAR_7).unwrap();
